...
class SessionManager
{
    ...
    private function handleSessionExpired(string $reason): void
    {
        ...
        // Volontairement non consigné : une session qui expire après inactivité
        // est le comportement attendu, pas un incident. La raison est portée
        // jusqu'à la page de connexion par ?session_expired=1, qui l'explique à
        // l'utilisateur — c'est le seul endroit où elle est utile.
