...
return function($router) {
    $router->group('/admin/configuration', function($router) {
        ...
        $router->post('/save-twofa',    'Configuration\\Controllers\\ConfigurationController@saveTwoFactor');
        $router->post('/twofa-test',    'Configuration\\Controllers\\ConfigurationController@testTwoFactorMail');
        $router->post('/twofa-recovery','Configuration\\Controllers\\ConfigurationController@regenerateTwoFactorRecovery');
        $router->post('/save-domains',  'Configuration\\Controllers\\ConfigurationController@saveDomains');
        $router->post('/domain-test',   'Configuration\\Controllers\\ConfigurationController@testDomain');
