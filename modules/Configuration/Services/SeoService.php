...
class SeoService
{
    ...
    {
        // Les méta-templates globaux (title/description/keywords/robots) ont été
        // retirés : ils n'étaient pas consommés côté public (chaque module — Blogging,
        // Forum, Marketplace — gère son propre SEO). On ne conserve que les assets
        // réellement utilisables comme défauts site-wide : logo, favicon, image OG
        // et l'identifiant Google Analytics.
        return [
