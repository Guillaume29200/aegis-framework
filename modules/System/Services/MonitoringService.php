...
class MonitoringService
{
    ...
    {
        // Source unique de vérité : le changelog du framework.
        $changelog = (defined('ROOT_PATH') ? ROOT_PATH : dirname(__DIR__, 3)) . '/framework/changelog.json';
        if (is_file($changelog)) {
            $data = json_decode((string)file_get_contents($changelog), true);
