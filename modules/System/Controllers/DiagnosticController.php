...
class DiagnosticController
{
    ...
    public function index(): void
    {
        ...
        // Rafraîchir le cache utilisé par le bandeau d'alerte du header (cohérence
        // immédiate après une réparation, sans attendre l'expiration du cache).
        $_SESSION['adm_diag_cache'] = ['t' => time(), 'errors' => (int) ($summary['error'] ?? 0)];
