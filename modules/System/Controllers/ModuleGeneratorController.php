...
class ModuleGeneratorController
{
    ...
    public function index(): void
    {
        ...
        // Capacités transverses proposées à la génération (source unique : le registre).
        $capabilities = \Framework\Capabilities\CapabilityRegistry::all();
    ...
    public function generate(): void
    {
        ...
        $result = $service->generate([
            ...
            // Capacités transverses cochées ; ModuleGeneratorService ne garde que les disponibles.
            'capabilities'    => (array)($_POST['capabilities'] ?? []),
            // Partie publique : moteur de gabarits, thème livré et écrans de thèmes.
            'public'          => isset($_POST['public']),
            'theme'           => $_POST['theme'] ?? '',
            'theme_name'      => $_POST['theme_name'] ?? '',
            // Gabarits demandés : liste + fiche, et ses deux variantes.
            'tpl_list'        => isset($_POST['tpl_list']),
            'tpl_pagination'  => isset($_POST['tpl_pagination']),
            'tpl_search'      => isset($_POST['tpl_search']),
        ]);
