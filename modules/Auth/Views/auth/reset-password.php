        ...
        <section class="auth-panel">
            <div class="auth-card">
                ...
                <form id="resetForm" method="POST" action="<?= u('/auth/reset-password') ?>" class="auth-form">
                    ...
                    <div class="f-field"><label for="password">Nouveau mot de passe</label><input type="password" id="password" name="password" required autocomplete="new-password" minlength="<?= $pwPolicy->longueurMinimale() ?>"><p class="f-hint">🔐 <?= htmlspecialchars($pwPolicy->enonce()) ?></p></div>
