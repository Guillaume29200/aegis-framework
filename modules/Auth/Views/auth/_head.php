...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* La règle appliquée, annoncée avant la saisie : se faire refuser sans
           savoir pourquoi est la première cause d'abandon d'une inscription. */
        .f-field .f-hint { margin:6px 0 0; font-size:12px; line-height:1.45; color:#64748b; }
