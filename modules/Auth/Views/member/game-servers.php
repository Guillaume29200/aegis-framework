        ...
        <article class="panel" style="margin-top:18px">
            ...
            <div class="table-wrap">
                <table class="member-table">
                    <thead>
                        <tr><th>🖥️ Serveur</th><th>🕹️ Jeu</th><th>⚡ Statut</th><th>🌐 Adresse</th><th>👥 Joueurs</th></tr>
                    </thead>
                    <tbody>
                    ...
                    <?php endforeach; ?>
                    <?php if (empty($gameServers)): ?><tr><td colspan="6">Aucun serveur de jeux ne vous est encore alloue.</td></tr><?php endif; ?>
                    </tbody>
                </table>
            </div>
        </article>
